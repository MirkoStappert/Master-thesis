...
\begin{lem}  \label{PropertiesTHH}
    ...
    4.) If $R$ is a connective, $p$-complete spectrum and of finite type %\footnote{This means, that $R$ is a filtered colimit of perfect $A$-module spectra along increasingly connective maps.}
